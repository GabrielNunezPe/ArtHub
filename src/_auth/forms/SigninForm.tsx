    ...
    return (
        <Form {...form}>
            ...
            <div className="sm:w-420 flex-center flex-col">
                ...
                <p className="text-light-3 small-medium md:base-regular mt-2">¡Bienvenido! Por favor, introduce tus credenciales</p>       
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
                    ...
                    <p className="text-small-regular text-light-2 text-center mt-2">
                        ...
                        <Link to="/sign-up" className="text-primary-500 text-small-semibold ml-1">Registrarse</Link>
                    </p>
